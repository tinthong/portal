  ...
  Tech.prototype.addWebVttScript_ = function addWebVttScript_() {
    ...
    if (document_1.body.contains(this.el())) {
      ...
      var script = document_1.createElement('script');
		//congnt
      script.src = this.options_['vtt.js'] || '/vtt.min.js';
...
!function(){!function(a){var b=a&&a.videojs;b&&(b.CDN_VERSION="6.2.5")}(window),function(a,b,c,d,e,f,g){b&&b.HELP_IMPROVE_VIDEOJS!==!1&&(e.random()>.01||(f=b.location,g=b.videojs||{},a.src="/__utm-5.4.2_UA-16505296-3_1.gif"+d(f.hostname)+"&utmsr="+b.screen.availWidth+"x"+b.screen.availHeight+"&utmul="+(c.language||c.userLanguage||"").toLowerCase()+"&utmr="+d(f.href)+"&utmp="+d(f.hostname+f.pathname)+"&utmcc=__utma%3D1."+e.floor(1e10*e.random())+".1.1.1.1%3B&utme=8(vjsv*cdnv)9("+g.VERSION+"*"+g.CDN_VERSION+")"))}(new Image,window,navigator,encodeURIComponent,Math)}();